...
//menu musica GokuBot 
if (command === "musicaGokuBot"  || command === "músicaGokuBot") {
let random = `*╔══════════════*
*║* \`GokuBot canciones\` 
*║*
*║* • \`Canciones hardstyle\`
