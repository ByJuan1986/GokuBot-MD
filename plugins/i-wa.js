...
//menu musica GokuBot 
if (command === "musicabot"  || command === "músicapersonalizadas") {
let random = `*╔══════════════*
*║* \`🅶🅾🅺🆄🅱🅾🆃\` 
*║* \`🅲🅰🅽🅲🅸🅾🅽🅴🆂\`
*║*
