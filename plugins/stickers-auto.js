...
let nombre = "𝐆𝐨𝐤𝐮𝐁𝐨𝐭" //nombre del sticker en config.js
let nombre2 = "𝐁𝐲 𝐉𝐮𝐚𝐧𝟏𝟗𝟖𝟔" //nombre del sticker en config.js
...
handler.customPrefix = /hola|👋|👋🏼|👋🏽|👋🏾|👋🏿|pelea|🤜|🤛|comida|voy a comer|estoy comiendo|comiendo|🥝|🥑|🥔|🥞|🥖|🥐|🍥|🥮|🍩|🥧|🍛|🍪|🎂|🍰|🧁|enfadado|😡|😠|😤|😭|😥|😢|😱|👍|🆗|👌|alegre|😊|😀|guantazo|amor|🥰|😍|🫶|❤️|😚|baile|llorar|miedo|ok|papus|payaso|pienso|🤔|risa|🤣|😂|😄|😁|😊|triste|☹️|🙁|vacilon|mondongo/i
...
'https://od.lk/s/NTZfNTM1OTc5OTVf/alegre%2002.png',
...
'https://od.lk/s/NTZfNDc3NDU3ODRf/Bofetada%209.gif'
]
...
const ok = [
'https://od.lk/s/NTZfNTM1NjMyMDdf/ok%2001.png',
