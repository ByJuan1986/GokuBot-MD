...
if (!m.quoted && !text) return conn.reply(m.chat, `╭❪ 💬 ›› _Ingrese el comando y responda a un mensaje para replicarlo._`, m)
...
let htextos = `${text ? text : "╭❪ ❌ ›› _Ocurrio un error, intentalo de nuevo._"}`
