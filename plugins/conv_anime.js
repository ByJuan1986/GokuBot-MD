...
const handler = async (m, {conn, text, args, usedPrefix, command}) => {
  ...
  if (!/image/g.test(mime)) throw '╭❪ 💬 ›› _Ingrese el comando y responda a una imagen con una cara visible para convertirlo en anime._';
  m.reply('╭❪ ⏳ ›› _Convirtiendo imagen a anime, espere un momento..._');
