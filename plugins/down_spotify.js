...
let pontexto = '╭❪ 💬 ›› _Ingrese el comando y escriba el nombre de una artista para buscarlo en Spotify._'
let espere = '╭❪ ⏳ ›› _Buscando resultados, espere un momento..._'
let sinresultado = '╭❪ 📌 ›› _No se ha encontrado resultados, intentalo de nuevo._'
if (!text) throw `${pontexto}`
try {
conn.reply(m.chat, espere, m)
let songInfo = await spotifyxv(text)
if (!songInfo.length) throw `${sinresultado}`
let res = songInfo[0]
