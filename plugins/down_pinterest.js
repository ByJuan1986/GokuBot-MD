...
let pontexto = '╭❪ 💬 ›› _Ingrese el comando y escriba un texto para buscarlo en Pinterest._'
let espere = '╭❪ ⏳ ›› _Buscando imagenes, espere un momento..._'
  if (!_0x27db11) {
    return _0x9c7141.reply(_0x10bd40.chat, pontexto, _0x10bd40);
  }
    await _0x10bd40.react(rwait);
 _0x9c7141.reply(_0x10bd40.chat, espere, _0x10bd40)
