...
console.log(`╭──────· ⽷ « GokuBot » ⽷
│${chalk.greenBright('Bot:')} ${chalk.cyanBright(me)} ~ ${chalk.blueBright(userName)} ${global.conn.user.jid === conn.user.jid ? chalk.cyanBright('(Principal)') : chalk.cyanBright('(sub-bot.)')}
│Remitente: ${chalk.greenBright(sender)}
